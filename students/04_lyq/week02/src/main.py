...
if not os.path.exists('./students/04_lyq/week02/docs'):
    os.makedirs('./students/04_lyq/week02/docs')
plt.savefig('./students/04_lyq/week02/docs/regression_plot.png', dpi=300, bbox_inches='tight')
plt.close()
...
with open('./students/04_lyq/week02/docs/experiment_report.md', 'w', encoding='utf-8') as f:
    f.write(report)

# ===================== 控制台输出 =====================
print("="*50)
print("✅ 运行成功！文件保存在 ./students/04_lyq/week02/docs/")
